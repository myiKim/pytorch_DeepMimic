...
import time
import math
from _pybullet_env import motion_capture_data
...
pybullet_client.setAdditionalSearchPath(_pybullet_data.getDataPath())
...
motionPath = _pybullet_data.getDataPath()+"/data/motions/humanoid3d_walk.txt"
# motionPath = _pybullet_data.getDataPath() + "/data/motions/humanoid3d_backflip.txt"
mocapData.Load(motionPath)
timeStep = 1. / 600
useFixedBase = False
humanoid = HumanoidStablePD(pybullet_client, mocapData, timeStep, useFixedBase)
isInitialized = True
